...
function insert(cloudantDb, index, fct, args, addData,  params) {
  return new Promise(function(resolve, reject) {
    ...
    var cloudantDocName = formatted + toString(index);
    var doc = {
            "_id": cloudantDocName,
            "timestamp": formatted,
            "fct": fct,
...
function main(args) {
    ...
    var cloudantDb = cloudant.db.use("testdb");
       ...
       insert(cloudantDb, "4", "IntentRequest received", args, "-",  params);
        ...
        if (args.request.intent.name === "askDiscovery"){
            ...
            if (searchString === 'undefined') {
                ...
                var queryString = {'query':"Hartmut Seitter"};
                    ...
                    discovery.query({
                           ...
                           collection_id: 'f1fd3604-5d65-4aab-a919-8dadfcb55112',
                            ...
                            if (err) {
                                ...
                                insert(cloudantDb,"6", "Return from Discovery", queryString, "-",  params);                    
